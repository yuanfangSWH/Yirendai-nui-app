<template>
	<view>
		<view class="wrd-mony-box">
			<view class="bk_s">
				<span><img src="../../../static/images/wc_icon.png" style="width: 18% !important;" /></span>
				<p style="margin-top: 10px;">提现申请已提交</p>
				<em>银行处理中，资金将在24小时内到账</em>
			</view>
			<ul class="cash_ul01">
				<li>
					<span class="cash_xq_s01">储蓄卡</span>
					<span class="cash_xq_s02">{{ cardData }}</span>
				</li>
				<li>
					<span class="cash_xq_s01">提现金额</span>
					<span class="cash_xq_s02">¥{{ goldData }}</span>
				</li>
			</ul>
